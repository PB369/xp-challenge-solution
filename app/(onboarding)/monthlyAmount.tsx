  ...
  return (
    <View className="flex-1 justify-center items-center bg-black w-full">
      <View className="w-4/5 justify-center items-center">
        ...
        <Image 
          source={require('@/assets/images/onboarding-images/monthlyAmount-image.png')} 
          style={{width: 258, height: 258, marginBottom:16}}
        />

        <Text className="text-white text-center font-semibold" style={{fontSize:26}}>
          Quanto você pretende alocar mensalmente para seus investimentos?
        </Text>
        ...
        <View className="flex-col w-full justify-center items-center">
          <Pressable 
            onPress={handleNext} 
            className={`${monthlyAmount.length===0 && 'opacity-70'} bg-yellow-400 my-2 py-2 w-full rounded-md`} 
            disabled={monthlyAmount.length===0}
          >
